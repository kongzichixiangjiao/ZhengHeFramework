...
import UIKit
import dsBridge
private let appUserAgent = "ZHXX_JF_IOS" //普信财富顾问app的userAgent标识
...
class ZHBaseBridgeWebviewController: GANormalizeBaseViewController,WKNavigationDelegate,ZHDsbridgeUtilsToolsDelegate {
    ...
    convenience init(url:String, _ title:String = "", _ bridgeName:ZHBaseDsbridgeUtilsTools = ZHBaseDsbridgeUtilsTools() ) {
        self.init()
        self.title = title
        self.webUrl = url

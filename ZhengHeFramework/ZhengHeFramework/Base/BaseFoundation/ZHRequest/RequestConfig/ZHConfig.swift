...
let kDevelopEnvironment_Url: ZHBaseUrlType = .other
let kDevelopEnvironment_H5_Url: ZHH5BaseUrlType = .test

enum ZHBaseUrlType: String {
    case product     = "product"
    case zhunProduct = ""
    case test        = "http://jfapp.zhengheht.com/jfapp"
    case other       = "http://172.22.43.175:8080/ocs"
}

enum ZHH5BaseUrlType: String {
    case product     = "product"
    case zhunProduct = ""
    case test        = "http://jfapp.zhengheht.com"
    case other       = "other" // 一卡通
}

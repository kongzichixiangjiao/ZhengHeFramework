...
class GANormalizeTabbarView: UIView {
    ...
    weak var mDelegate: GANormalizeTabbarViewDelegate?
    
    var currentIndex: Int = 0
    
    @IBOutlet var buttons: [YYXibTabBarItem]!
    
    static func loadBaseXibTabBarView(nibName: String = "GANormalizeTabbarView") -> GANormalizeTabbarView {
        return Bundle.main.loadNibNamed(nibName, owner: self, options: nil)?.last as! GANormalizeTabbarView
    }
